...
public class ShiftRequestController {
        ...
        public String list(
                ...
                // 対象月の勤務希望だけ取得する
                List<ShiftRequest> shiftRequests = shiftRequestRepository.findAll().stream()
        ...
        private String validateShiftRequest(
                ...
                // 今回の登録内容が休み希望か確認する
                boolean isDayOff = isDayOffRequest(requestType);
                ...
                for (ShiftRequest existingRequest : shiftRequests) {
                        ...
                        boolean sameEmployee = existingRequest
                                        .getEmployee()
                                        .getId()
                                        .equals(employeeId);

                        boolean sameDate = existingRequest
                                        .getWorkDate()
                                        .equals(workDate);
                        ...
                        boolean existingIsDayOff = isDayOffRequest(
                        ...
                        boolean overlaps = startTime.isBefore(
